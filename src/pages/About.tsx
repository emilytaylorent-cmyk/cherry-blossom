...
import Download from "../assets/pictures/DownloadIcon.svg"
      ...
      <SectionHolder>
        <div className='flex flex-row justify-between pt-[5%]'>
          ...
          <div className='w-[40%] gap-[20] items-center justify-center'>
            ...
            {/* insert button here */}
            <div className='border-[#C999BC] border-2 rounded-sm font-["Kameron"] text-[18px] p-3 flex flex-row gap-2 items-center justify-center hover:bg-[#C999BC] hover:border-[#F1D6E0] hover:cursor-pointer'>
              <img src={Download} />
              Download Resume Here</div>
          </div>
